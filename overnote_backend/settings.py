"""
Django settings for overnote_backend project.
...
SECRET_KEY = "django-insecure-4mo@zj4!s9627rrp@g*ar3y4@poq^*^qpfd_!^%lk3z(e=bvfr"
...
ROOT_URLCONF = "overnote_backend.urls"
...
WSGI_APPLICATION = "overnote_backend.wsgi.application"
